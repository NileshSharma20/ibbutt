...
function ClassyButt() {
  ...
  return (
    ...
    <div className='nav-container'>
      ...
      <div className="circle-on-hover" onClick={()=>window.scrollTo({top:roadmapRef.current.offsetTop, behavior:"smooth"})}>
        Roadmap
      </div>

      <div className="circle-on-hover" onClick={()=>window.scrollTo({top:utilRef.current.offsetTop, behavior:"smooth"})}>
        Utilities
      </div>
    ...
    {/* About */}
    <div className='util-container' ref={posterRef}>
    ...
    {/* Roadmap */}
    <div className="util-container" ref={roadmapRef}>
